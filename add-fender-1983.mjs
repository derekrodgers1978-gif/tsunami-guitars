...
const guitar={
  ...
  specs:[['Year','1983'],['Model','USA Standard Stratocaster'],['Finish','Sunburst'],['Serial','E3 344655'],['Made In','USA'],['Neck / Fingerboard','Maple / Maple'],['Frets','21 · Excellent Condition'],['Pickups','Three Single-Coils'],['Selector','5-Way'],['Controls','2-Knob · Volume / Tone'],['Tremolo','Freeflyte'],['Output Jack','Top-Mounted'],['Condition','Excellent · Very Little Play Wear'],['Includes','Original Fender Hardshell Case']],
  images:['fender-usa-standard-stratocaster-1983-01.jpeg','fender-usa-standard-stratocaster-1983-02-fixed.jpeg','fender-usa-standard-stratocaster-1983-03-fixed.jpeg','fender-usa-standard-stratocaster-1983-04.jpeg','fender-usa-standard-stratocaster-1983-05.jpeg','fender-usa-standard-stratocaster-1983-06.jpeg','fender-usa-standard-stratocaster-1983-07.jpeg','fender-usa-standard-stratocaster-1983-08.jpeg','fender-usa-standard-stratocaster-1983-09.jpeg','fender-usa-standard-stratocaster-1983-10.jpeg','fender-usa-standard-stratocaster-1983-11.jpeg'],
  tags:['fender','stratocaster','usa','1983','2-knob','freeflyte','sunburst','vintage'],
  on_sale:false
};
const i=data.guitars.findIndex(g=>g.id===id);
if(i>=0) data.guitars[i]=guitar; else data.guitars.unshift(guitar);
